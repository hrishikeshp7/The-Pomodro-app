...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            // ⚡ Bolt Optimization: Using collectAsStateWithLifecycle instead of collectAsState
            // This ensures UI collection stops when the lifecycle drops below STARTED,
            // preventing unnecessary background work and saving CPU/battery resources.
